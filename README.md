...
* [cmux](https://github.com/manaflow-ai/cmux) ⭐ 26,394 | 🐛 4,420 | 🌐 Swift | 📅 2026-08-24 — A Ghostty-based macOS terminal with vertical tabs and notifications for AI coding agents. Features notification rings, in-app browser, SSH support, and Claude Code Teams integration.
...
* [Baz CLI](https://github.com/baz-scm/baz-cli) ⭐ 48 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-04 - CLI for AI assisted code review, with access to the actual code, diff etc.
...
* [Clave](https://github.com/codika-io/clave) ⭐ 47 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-24 — Native macOS app for managing multiple Claude Code sessions in parallel, with split/grid layouts, session groups, SSH remote sessions, a git panel, conversation history, and usage analytics. Free, open-source (MIT), local-first.
...
* [Qodo PR Agent](https://github.com/qodo-ai/pr-agent) ⭐ 12,680 | 🐛 136 | 🌐 Python | 📅 2026-08-23 — Open source tool for automated code reviews. Qodo was formerly known as Codium (not to be confused with Codeium with an "E").
...
* [Trellis](https://github.com/mindfold-ai/Trellis) ⭐ 14,185 | 🐛 36 | 🌐 TypeScript | 📅 2026-08-21 — All-in-one AI framework & toolkit for Claude Code & Cursor. Manages tasks, specs, and multi-agent pipelines.
...
* [Bernstein](https://github.com/chernistry/bernstein) ⭐ 972 | 🐛 177 | 🌐 Python | 📅 2026-08-24 — Deterministic multi-agent orchestrator that spawns parallel coding agents (Claude Code, Codex CLI, Gemini CLI) from a single goal, verifies with tests, and auto-commits. Zero LLM tokens on coordination.
* [SwarmClaw](https://github.com/swarmclawai/swarmclaw) ⭐ 653 | 🐛 14 | 🌐 TypeScript | 📅 2026-06-30 - Self-hosted AI runtime that orchestrates Claude Code, Codex, Gemini CLI, OpenCode, Copilot CLI, Cursor Agent, Goose, Qwen Code, and Droid with heartbeats, schedules, delegation, runtime skills, and an org chart view. Ships as a desktop app (Electron) and CLI. MIT licensed, TypeScript.
...
* [LoopTroop](https://github.com/looptroop-ai/LoopTroop) ⭐ 123 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-24 — Local GUI orchestrator for AI coding agents with multi-model planning (LLM councils), iterative retry loops, and isolated git worktrees for long-running, correctness-first multi-file work.
...
* [GAAI Framework](https://github.com/Fr-e-d/GAAI-framework) ⭐ 160 | 🐛 0 | 🌐 Shell | 📅 2026-08-23 — Drop-in governance layer for AI coding tools. Backlog-first delivery, cross-session memory, decision tracking, QA gates, and autonomous delivery daemon. Works with Claude Code, Cursor, Codex CLI, Gemini CLI, Windsurf. Markdown + YAML + bash, zero dependencies.
* [KubeStellar Console kc-agent](https://github.com/kubestellar/console) ⭐ 127 | 🐛 38 | 🌐 TypeScript | 📅 2026-08-24 — MCP server that bridges AI coding agents (Claude Code, Copilot, Codex) to multi-cluster Kubernetes APIs. Enables natural language queries across clusters, workload placement, policy enforcement, and real-time observability. CNCF Sandbox project.
...
* [LynxPrompt](https://github.com/GeiserX/LynxPrompt) ⭐ 44 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-24 — Self-hostable platform for managing AI IDE configuration files. Generates, syncs, and shares configs (.cursorrules, CLAUDE.md, copilot-instructions.md, etc.) across 30+ AI coding assistants via web UI, REST API, CLI, and federated blueprint marketplace.
...
* [Tokscale](https://github.com/junhoyeo/tokscale) ⭐ 5,144 | 🐛 76 | 🌐 Rust | 📅 2026-08-22 — CLI tool for tracking token usage from AI coding agents (OpenCode, Claude Code, OpenClaw, Codex, Gemini CLI, Cursor IDE, AmpCode, Factory Droid) with a global leaderboard and 2D/3D contribution graphs.
...
* [git-lrc](https://github.com/HexmosTech/git-lrc) ⭐ 1,454 | 🐛 17 | 🌐 Go | 📅 2026-08-23 - Free, unlimited AI code reviews that run on every commit.
