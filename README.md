...
> \[!IMPORTANT]
> Please read the [contribution rules](https://github.com/jamesmurdza/awesome-ai-devtools/blob/7ac2078505606be2dd84c24075744a3643f08241/.github/PULL_REQUEST_TEMPLATE.md?plain=1#L4-L10) ⭐ 3,928 | 🐛 280 | 📅 2026-08-27 before submitting a PR.
...
* [cmux](https://github.com/manaflow-ai/cmux) ⭐ 26,743 | 🐛 4,773 | 🌐 Swift | 📅 2026-09-03 — A Ghostty-based macOS terminal with vertical tabs and notifications for AI coding agents. Features notification rings, in-app browser, SSH support, and Claude Code Teams integration.
...
* [IWE](https://github.com/iwe-org/iwe) ⭐ 1,614 | 🐛 0 | 🌐 Rust | 📅 2026-08-30 — Markdown knowledge graph with CLI that gives AI agents structured access to your knowledge base — no vector database required.
* [codesight](https://github.com/Houseofmvps/codesight) ⭐ 1,395 | 🐛 2 | 🌐 TypeScript | 📅 2026-07-27 — CLI token optimizer and AI context generator. Scans codebases to extract routes, schema, components, and dependencies for Claude Code, Cursor, Copilot, Codex, and Windsurf. 9x–13x token reduction, built-in MCP server, zero runtime dependencies.
* [models](https://github.com/arimxyer/models) ⭐ 504 | 🐛 0 | 🌐 Rust | 📅 2026-09-03 — A TUI for browsing AI models, benchmarks from Artificial Analysis, and coding agents with GitHub integration. Built with Rust and Ratatui.
...
* [Octomind](https://github.com/muvon/octomind) ⭐ 120 | 🐛 1 | 🌐 Rust | 📅 2026-09-03 — Session-based AI development assistant with MCP support, 7 LLM providers, and extensible architecture. Features plan-first workflow, semantic code search, and persistent memory.
...
* [Parallel Code](https://github.com/johannesjo/parallel-code) ⭐ 1,000 | 🐛 50 | 🌐 TypeScript | 📅 2026-09-03 - Desktop app that runs multiple AI coding agents (Claude Code, Codex CLI, Gemini CLI) in parallel with automatic git worktree isolation, a unified GUI, and remote monitoring.
* [IM.codes](https://github.com/im4codes/imcodes) ⭐ 973 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-03 — Mobile/web control layer for Claude Code, Codex, Gemini CLI, and other terminal-based coding agents, built for away-from-desk continuation with terminal access, file browsing, git views, localhost preview, notifications, and multi-agent workflows.
...
* [Qodo PR Agent](https://github.com/qodo-ai/pr-agent) ⭐ 12,837 | 🐛 83 | 🌐 Python | 📅 2026-09-03 — Open source tool for automated code reviews. Qodo was formerly known as Codium (not to be confused with Codeium with an "E").
...
* [Trellis](https://github.com/mindfold-ai/Trellis) ⭐ 14,429 | 🐛 50 | 🌐 TypeScript | 📅 2026-08-27 — All-in-one AI framework & toolkit for Claude Code & Cursor. Manages tasks, specs, and multi-agent pipelines.
* [Bernstein](https://github.com/chernistry/bernstein) ⭐ 1,083 | 🐛 291 | 🌐 Python | 📅 2026-09-03 — Deterministic multi-agent orchestrator that spawns parallel coding agents (Claude Code, Codex CLI, Gemini CLI) from a single goal, verifies with tests, and auto-commits. Zero LLM tokens on coordination.
* [Sidecar](https://github.com/marcus/sidecar) ⭐ 1,051 | 🐛 27 | 🌐 Go | 📅 2026-09-03 — Terminal UI companion for CLI-based coding agents (Claude Code, Cursor, Gemini) with unified conversation history, git integration, task management, and workspace control.
* [SwarmClaw](https://github.com/swarmclawai/swarmclaw) ⭐ 659 | 🐛 18 | 🌐 TypeScript | 📅 2026-06-30 - Self-hosted AI runtime that orchestrates Claude Code, Codex, Gemini CLI, OpenCode, Copilot CLI, Cursor Agent, Goose, Qwen Code, and Droid with heartbeats, schedules, delegation, runtime skills, and an org chart view. Ships as a desktop app (Electron) and CLI. MIT licensed, TypeScript.
...
* [Shep](https://github.com/shep-ai/cli) ⭐ 247 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-03 — Multi-session SDLC control center that orchestrates AI coding agents (Claude Code, Cursor CLI, Gemini) for autonomous feature development with configurable approval gates and a live web dashboard.
* [LoopTroop](https://github.com/looptroop-ai/LoopTroop) ⭐ 130 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-03 — Local GUI orchestrator for AI coding agents with multi-model planning (LLM councils), iterative retry loops, and isolated git worktrees for long-running, correctness-first multi-file work.
...
* [mirrord](https://github.com/metalbear-co/mirrord) ⭐ 5,296 | 🐛 79 | 🌐 Rust | 📅 2026-09-03 — Per-agent isolation inside a shared Kubernetes cluster: traffic filters, DB branches, and Kafka queue splits via the mirrord Operator. Six [Claude Code skills](https://github.com/metalbear-co/skills) ⭐ 27 | 🐛 1 | 🌐 Shell | 📅 2026-09-01 cover quickstart, config, operator setup, CI, DB branching, and Kafka splitting; install via `/plugin marketplace add metalbear-co/skills`.
* [Open Agent](https://github.com/Th0rgal/openagent) ⭐ 494 | 🐛 15 | 🌐 Rust | 📅 2026-09-03 — Self-hosted control plane for Claude Code with isolated container workspaces and real-time mission streaming.
* [brood-box](https://github.com/stacklok/brood-box) ⭐ 64 | 🐛 13 | 🌐 Go | 📅 2026-09-02 — Run coding agents (Claude Code, Codex, OpenCode) inside hardware-isolated microVMs with snapshot isolation and egress control.
...
* [KubeStellar Console kc-agent](https://github.com/kubestellar/console) ⭐ 132 | 🐛 57 | 🌐 TypeScript | 📅 2026-09-03 — MCP server that bridges AI coding agents (Claude Code, Copilot, Codex) to multi-cluster Kubernetes APIs. Enables natural language queries across clusters, workload placement, policy enforcement, and real-time observability. CNCF Sandbox project.
...
* [faf-cli](https://github.com/Wolfe-Jam/faf-cli) ⭐ 37 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-02 — Foundational AI-context format. Generates persistent project DNA (.faf files) that give any AI instant, structured context. IANA-registered (application/vnd.faf+yaml). Works with Claude, Gemini, Grok, Cursor, and Windsurf.
...
* [Tokscale](https://github.com/junhoyeo/tokscale) ⭐ 5,276 | 🐛 78 | 🌐 Rust | 📅 2026-09-03 — CLI tool for tracking token usage from AI coding agents (OpenCode, Claude Code, OpenClaw, Codex, Gemini CLI, Cursor IDE, AmpCode, Factory Droid) with a global leaderboard and 2D/3D contribution graphs.
...
* [AI Coding Guide (中文)](https://github.com/jnMetaCode/ai-coding-guide) ⭐ 514 | 🐛 0 | 🌐 CSS | 📅 2026-07-23 — Chinese best practices for 8 AI coding tools (Claude Code, Cursor, Copilot, Windsurf, Gemini CLI, Kiro, Aider, Trae) with copy-paste config templates and multi-tool collaboration workflows.
* [Awesome AI Startups — Coding & Developer Tools](https://github.com/nowork-studio/awesome-ai-startups#-coding--developer-tools) ⭐ 79 | 🐛 43 | 📅 2026-09-02 — 100+ indie-built AI coding assistants, dev tools, and code-generation products from bootstrapped, pre-seed, and angel-funded startups.
