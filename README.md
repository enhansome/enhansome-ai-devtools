...
* [cmux](https://github.com/manaflow-ai/cmux) ⭐ 27,065 | 🐛 4,929 | 🌐 Swift | 📅 2026-09-13 — A Ghostty-based macOS terminal with vertical tabs and notifications for AI coding agents. Features notification rings, in-app browser, SSH support, and Claude Code Teams integration.
...
* [CCG Workflow](https://github.com/fengshao1227/ccg-workflow) ⭐ 5,880 | 🐛 1 | 🌐 Go | 📅 2026-09-03 — Multi-model collaboration system for Claude Code. Orchestrates Claude + Codex + Gemini with 28 slash commands, smart routing (Gemini for frontend, Codex for backend), Agent Teams for parallel development, and 6 built-in quality gate skills. One-command install via npx.
* [IWE](https://github.com/iwe-org/iwe) ⭐ 1,641 | 🐛 0 | 🌐 Rust | 📅 2026-09-12 — Markdown knowledge graph with CLI that gives AI agents structured access to your knowledge base — no vector database required.
* [codesight](https://github.com/Houseofmvps/codesight) ⭐ 1,404 | 🐛 3 | 🌐 TypeScript | 📅 2026-07-27 — CLI token optimizer and AI context generator. Scans codebases to extract routes, schema, components, and dependencies for Claude Code, Cursor, Copilot, Codex, and Windsurf. 9x–13x token reduction, built-in MCP server, zero runtime dependencies.
* [models](https://github.com/arimxyer/models) ⭐ 506 | 🐛 0 | 🌐 Rust | 📅 2026-09-13 — A TUI for browsing AI models, benchmarks from Artificial Analysis, and coding agents with GitHub integration. Built with Rust and Ratatui.
* [ORCH](https://github.com/oxgeneral/ORCH) ⭐ 162 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-01 — CLI runtime that coordinates Claude Code, OpenCode, Codex, and Cursor as a typed AI team. State machine (todo→review→done), auto-retry, inter-agent messaging, TUI dashboard.
* [Octomind](https://github.com/muvon/octomind) ⭐ 135 | 🐛 2 | 🌐 Rust | 📅 2026-09-13 — Session-based AI development assistant with MCP support, 7 LLM providers, and extensible architecture. Features plan-first workflow, semantic code search, and persistent memory.
...
* [Parallel Code](https://github.com/johannesjo/parallel-code) ⭐ 1,007 | 🐛 51 | 🌐 TypeScript | 📅 2026-09-13 - Desktop app that runs multiple AI coding agents (Claude Code, Codex CLI, Gemini CLI) in parallel with automatic git worktree isolation, a unified GUI, and remote monitoring.
* [IM.codes](https://github.com/im4codes/imcodes) ⭐ 973 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-13 — Mobile/web control layer for Claude Code, Codex, Gemini CLI, and other terminal-based coding agents, built for away-from-desk continuation with terminal access, file browsing, git views, localhost preview, notifications, and multi-agent workflows.
...
* [Clave](https://github.com/codika-io/clave) ⭐ 47 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-13 — Native macOS app for managing multiple Claude Code sessions in parallel, with split/grid layouts, session groups, SSH remote sessions, a git panel, conversation history, and usage analytics. Free, open-source (MIT), local-first.
...
* [Qodo PR Agent](https://github.com/qodo-ai/pr-agent) ⭐ 12,964 | 🐛 102 | 🌐 Python | 📅 2026-09-13 — Open source tool for automated code reviews. Qodo was formerly known as Codium (not to be confused with Codeium with an "E").
* [Gito](https://github.com/Nayjest/Gito) ⭐ 430 | 🐛 59 | 🌐 Python | 📅 2026-09-05 - AI code reviewer that works with any language model, locally or in GitHub Actions.
...
* [Trellis](https://github.com/mindfold-ai/Trellis) ⭐ 14,611 | 🐛 54 | 🌐 TypeScript | 📅 2026-09-11 — All-in-one AI framework & toolkit for Claude Code & Cursor. Manages tasks, specs, and multi-agent pipelines.
* [Bernstein](https://github.com/chernistry/bernstein) ⭐ 1,175 | 🐛 347 | 🌐 Python | 📅 2026-09-13 — Deterministic multi-agent orchestrator that spawns parallel coding agents (Claude Code, Codex CLI, Gemini CLI) from a single goal, verifies with tests, and auto-commits. Zero LLM tokens on coordination.
* [Sidecar](https://github.com/marcus/sidecar) ⭐ 1,071 | 🐛 28 | 🌐 Go | 📅 2026-09-08 — Terminal UI companion for CLI-based coding agents (Claude Code, Cursor, Gemini) with unified conversation history, git integration, task management, and workspace control.
* [SwarmClaw](https://github.com/swarmclawai/swarmclaw) ⭐ 670 | 🐛 18 | 🌐 TypeScript | 📅 2026-06-30 - Self-hosted AI runtime that orchestrates Claude Code, Codex, Gemini CLI, OpenCode, Copilot CLI, Cursor Agent, Goose, Qwen Code, and Droid with heartbeats, schedules, delegation, runtime skills, and an org chart view. Ships as a desktop app (Electron) and CLI. MIT licensed, TypeScript.
...
* [Shep](https://github.com/shep-ai/cli) ⭐ 253 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-08 — Multi-session SDLC control center that orchestrates AI coding agents (Claude Code, Cursor CLI, Gemini) for autonomous feature development with configurable approval gates and a live web dashboard.
* [LoopTroop](https://github.com/looptroop-ai/LoopTroop) ⭐ 136 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-13 — Local GUI orchestrator for AI coding agents with multi-model planning (LLM councils), iterative retry loops, and isolated git worktrees for long-running, correctness-first multi-file work.
...
* [mirrord](https://github.com/metalbear-co/mirrord) ⭐ 5,329 | 🐛 79 | 🌐 Rust | 📅 2026-09-11 — Per-agent isolation inside a shared Kubernetes cluster: traffic filters, DB branches, and Kafka queue splits via the mirrord Operator. Six [Claude Code skills](https://github.com/metalbear-co/skills) ⭐ 27 | 🐛 1 | 🌐 Shell | 📅 2026-09-08 cover quickstart, config, operator setup, CI, DB branching, and Kafka splitting; install via `/plugin marketplace add metalbear-co/skills`.
* [Open Agent](https://github.com/Th0rgal/openagent) ⭐ 509 | 🐛 16 | 🌐 Rust | 📅 2026-09-10 — Self-hosted control plane for Claude Code with isolated container workspaces and real-time mission streaming.
* [brood-box](https://github.com/stacklok/brood-box) ⭐ 65 | 🐛 13 | 🌐 Go | 📅 2026-09-11 — Run coding agents (Claude Code, Codex, OpenCode) inside hardware-isolated microVMs with snapshot isolation and egress control.
...
* [Caliber](https://github.com/rely-ai-org/caliber) ⭐ 1,268 | 🐛 16 | 🌐 TypeScript | 📅 2026-07-26 — Open-source CLI that scans your codebase and generates AI agent configs (CLAUDE.md, .cursorrules, skills, MCPs) for Claude Code, Cursor, and Codex. Scores your setup 0-100 and recommends MCP servers.
* [SwarmVault](https://github.com/swarmclawai/swarmvault) ⭐ 687 | 🐛 8 | 🌐 TypeScript | 📅 2026-06-30 - Local-first RAG knowledge vault and MCP server. Compiles raw sources (books, notes, transcripts, exports, datasets, slide decks, files, URLs, code) into a durable markdown wiki with a knowledge graph and a hybrid SQLite FTS plus embeddings index. The bundled MCP server (`npx -y @swarmvaultai/cli mcp`) gives Claude Code, Codex, OpenCode, and any MCP client page search, page reads, source listing, query, ingest, compile, and lint tools. MIT.
* [Entroly](https://github.com/juyterman1000/entroly) ⭐ 443 | 🐛 4 | 🌐 Python | 📅 2026-09-13 - Open-source context optimization engine that cuts AI token costs by 70-95%. Uses submodular knapsack selection and PRISM reinforcement learning to provide the exact context needed to 65+ supported AI coding agents. Features a built-in MCP server, semantic caching, and SimHash deduplication. Apache-2.0.
* [GAAI Framework](https://github.com/Fr-e-d/GAAI-framework) ⭐ 161 | 🐛 9 | 🌐 Shell | 📅 2026-09-11 — Drop-in governance layer for AI coding tools. Backlog-first delivery, cross-session memory, decision tracking, QA gates, and autonomous delivery daemon. Works with Claude Code, Cursor, Codex CLI, Gemini CLI, Windsurf. Markdown + YAML + bash, zero dependencies.
* [KubeStellar Console kc-agent](https://github.com/kubestellar/console) ⭐ 135 | 🐛 139 | 🌐 TypeScript | 📅 2026-09-13 — MCP server that bridges AI coding agents (Claude Code, Copilot, Codex) to multi-cluster Kubernetes APIs. Enables natural language queries across clusters, workload placement, policy enforcement, and real-time observability. CNCF Sandbox project.
...
* [skill-optimizer](https://github.com/fastxyz/skill-optimizer) ⭐ 79 | 🐛 14 | 🌐 TypeScript | 📅 2026-05-28 — CLI that benchmarks SDK, CLI, and MCP guidance docs (SKILL.md) against multiple LLMs and runs an iterative optimizer to rewrite them until every configured model meets a score floor.
* [LynxPrompt](https://github.com/GeiserX/LynxPrompt) ⭐ 47 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-11 — Self-hostable platform for managing AI IDE configuration files. Generates, syncs, and shares configs (.cursorrules, CLAUDE.md, copilot-instructions.md, etc.) across 30+ AI coding assistants via web UI, REST API, CLI, and federated blueprint marketplace.
* [faf-cli](https://github.com/Wolfe-Jam/faf-cli) ⭐ 39 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-13 — Foundational AI-context format. Generates persistent project DNA (.faf files) that give any AI instant, structured context. IANA-registered (application/vnd.faf+yaml). Works with Claude, Gemini, Grok, Cursor, and Windsurf.
...
* [ctxlint](https://github.com/YawLabs/ctxlint) ⭐ 10 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-13 — Open-source linter for AI context files (CLAUDE.md, .cursorrules, copilot-instructions.md) that catches stale paths, wrong commands, and token waste by validating against the real codebase.
...
* [Tokscale](https://github.com/junhoyeo/tokscale) ⭐ 5,419 | 🐛 70 | 🌐 Rust | 📅 2026-09-12 — CLI tool for tracking token usage from AI coding agents (OpenCode, Claude Code, OpenClaw, Codex, Gemini CLI, Cursor IDE, AmpCode, Factory Droid) with a global leaderboard and 2D/3D contribution graphs.
* [onWatch](https://github.com/onllm-dev/onwatch) ⭐ 736 | 🐛 9 | 🌐 Go | 📅 2026-09-11 — Open-source Go CLI that tracks AI API quota usage across 7 providers (Anthropic, OpenAI Codex, GitHub Copilot, Synthetic, Z.ai, MiniMax, Antigravity). Background daemon with Material Design 3 web dashboard, \~15MB binary, <50MB RAM, zero telemetry.
...
* [WhereMyTokens](https://github.com/jeongwookie/WhereMyTokens) ⭐ 79 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-11 — Windows system tray app for monitoring Claude Code token usage in real time. Displays per-session token counts, costs, context window usage, and tool call breakdowns; fetches 5h/1w rate-limit data from the Anthropic API with optional statusLine bridge integration for live data without polling.
...
* [git-lrc](https://github.com/HexmosTech/git-lrc) ⭐ 1,463 | 🐛 19 | 🌐 Go | 📅 2026-09-05 - Free, unlimited AI code reviews that run on every commit.
...
* [AI Coding Guide (中文)](https://github.com/jnMetaCode/ai-coding-guide) ⭐ 523 | 🐛 1 | 🌐 CSS | 📅 2026-09-10 — Chinese best practices for 8 AI coding tools (Claude Code, Cursor, Copilot, Windsurf, Gemini CLI, Kiro, Aider, Trae) with copy-paste config templates and multi-tool collaboration workflows.
* [Awesome AI Startups — Coding & Developer Tools](https://github.com/nowork-studio/awesome-ai-startups#-coding--developer-tools) ⭐ 80 | 🐛 44 | 📅 2026-09-12 — 100+ indie-built AI coding assistants, dev tools, and code-generation products from bootstrapped, pre-seed, and angel-funded startups.
