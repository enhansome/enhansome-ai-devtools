# ⚡️🧑‍💻 Awesome AI-Powered Developer Tools with stars
...
> \[!IMPORTANT]
> Please read the [contribution rules](https://github.com/jamesmurdza/awesome-ai-devtools/blob/7ac2078505606be2dd84c24075744a3643f08241/.github/PULL_REQUEST_TEMPLATE.md?plain=1#L4-L10) ⭐ 3,931 | 🐛 288 | 📅 2026-08-27 before submitting a PR.
...
* [Antigravity Link](https://github.com/cafeTechne/antigravity-link-extension) ⭐ 210 | 🐛 5 | 🌐 HTML | 📅 2026-06-04 — VS Code extension that bridges mobile devices to Google's Antigravity IDE. Mirror active AI chat sessions on your phone, send messages, upload files, stop AI generation, and automate workflows via a local HTTP API or 9 MCP tools. Listed in the official MCP Registry.
* [onUI](https://github.com/onllm-dev/onUI) ⭐ 98 | 🐛 1 | 🌐 TypeScript | 📅 2026-04-28 — Open-source browser extension and MCP server for annotation-first UI pair programming with AI agents. Annotate any webpage and bridge UI context to Claude Code, Cursor, Windsurf, or Copilot.
...
* [cmux](https://github.com/manaflow-ai/cmux) ⭐ 26,901 | 🐛 4,839 | 🌐 Swift | 📅 2026-09-08 — A Ghostty-based macOS terminal with vertical tabs and notifications for AI coding agents. Features notification rings, in-app browser, SSH support, and Claude Code Teams integration.
* [Blueprint](https://github.com/JuliusBrussee/blueprint) ⭐ 1,141 | 🐛 17 | 📅 2026-08-14 — A Claude Code plugin that turns natural language into blueprints, blueprints into parallel build plans, and build plans into working software with automated iteration, validation, and cross-model peer review.
...
* [CCG Workflow](https://github.com/fengshao1227/ccg-workflow) ⭐ 5,879 | 🐛 0 | 🌐 Go | 📅 2026-09-03 — Multi-model collaboration system for Claude Code. Orchestrates Claude + Codex + Gemini with 28 slash commands, smart routing (Gemini for frontend, Codex for backend), Agent Teams for parallel development, and 6 built-in quality gate skills. One-command install via npx.
* [IWE](https://github.com/iwe-org/iwe) ⭐ 1,628 | 🐛 0 | 🌐 Rust | 📅 2026-09-06 — Markdown knowledge graph with CLI that gives AI agents structured access to your knowledge base — no vector database required.
* [codesight](https://github.com/Houseofmvps/codesight) ⭐ 1,400 | 🐛 3 | 🌐 TypeScript | 📅 2026-07-27 — CLI token optimizer and AI context generator. Scans codebases to extract routes, schema, components, and dependencies for Claude Code, Cursor, Copilot, Codex, and Windsurf. 9x–13x token reduction, built-in MCP server, zero runtime dependencies.
* [models](https://github.com/arimxyer/models) ⭐ 505 | 🐛 0 | 🌐 Rust | 📅 2026-09-08 — A TUI for browsing AI models, benchmarks from Artificial Analysis, and coding agents with GitHub integration. Built with Rust and Ratatui.
* [ORCH](https://github.com/oxgeneral/ORCH) ⭐ 160 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-01 — CLI runtime that coordinates Claude Code, OpenCode, Codex, and Cursor as a typed AI team. State machine (todo→review→done), auto-retry, inter-agent messaging, TUI dashboard.
* [Octomind](https://github.com/muvon/octomind) ⭐ 135 | 🐛 1 | 🌐 Rust | 📅 2026-09-08 — Session-based AI development assistant with MCP support, 7 LLM providers, and extensible architecture. Features plan-first workflow, semantic code search, and persistent memory.
* [Baz CLI](https://github.com/baz-scm/baz-cli) ⭐ 48 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-25 - CLI for AI assisted code review, with access to the actual code, diff etc.
* [gptcomet](https://github.com/belingud/gptcomet) ⭐ 30 | 🐛 0 | 🌐 Go | 📅 2026-08-14 — CLI tool to help you generate commit message and review changes. Supports multiple providers and languages.
* [Jctx](https://github.com/Shashwat-Gupta57/Jctx) ⭐ 6 | 🐛 0 | 🌐 Python | 📅 2026-04-22 — Python CLI that extracts structured, architecture-aware context from Python, Kotlin, and Java codebases for LLMs. Features internal dependency mapping and token estimation.
* [prpack](https://github.com/Lucas2944/prpack) ⭐ 3 | 🐛 3 | 🌐 JavaScript | 📅 2026-05-12 — Zero-dep CLI that packs a pull request (diff + commits + full post-change file contents) into one markdown file optimized for LLM code review. Drop the file into Claude / Cursor / your model. MIT.
...
* [e2b\_Fragments](https://fragments.e2b.dev/) — Platform for building and deploying AI-powered applications with sandboxed environments.
...
* [Reflex](https://github.com/reflex-search/reflex) ⭐ 74 | 🐛 2 | 🌐 Rust | 📅 2026-07-06 — Local-first, full-text code search engine built for AI coding agents. Sub-100ms search across 10k+ files via trigram indexing, with structured JSON output and an optional MCP server so agents can query your entire codebase in a single tool call.
* [Grasp](https://github.com/ashfordeOU/grasp) ⭐ 20 | 🐛 0 | 🌐 HTML | 📅 2026-09-07 — Code architecture visualizer: paste any GitHub/GitLab URL → interactive dependency graph (9 layouts, 16 colour modes), A–F health score, security scanner (SARIF 2.1 export), blast radius, churn heatmap, ORM query map, and AI chat (15 providers). 116 MCP tools with Kuzu graph DB + SQLite brain. Zero data collection, everything runs locally.
* [sourcebook](https://github.com/maroondlabs/sourcebook) ⭐ 3 | 🐛 0 | 🌐 HTML | 📅 2026-04-16 — CLI and MCP server that generates AGENTS.md/CLAUDE.md from static analysis of codebase structure, git history, and convention detection. Surfaces hub files, co-change coupling, and blast radius. No LLM required.
...
* [Parallel Code](https://github.com/johannesjo/parallel-code) ⭐ 1,003 | 🐛 52 | 🌐 TypeScript | 📅 2026-09-07 - Desktop app that runs multiple AI coding agents (Claude Code, Codex CLI, Gemini CLI) in parallel with automatic git worktree isolation, a unified GUI, and remote monitoring.
* [IM.codes](https://github.com/im4codes/imcodes) ⭐ 973 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-08 — Mobile/web control layer for Claude Code, Codex, Gemini CLI, and other terminal-based coding agents, built for away-from-desk continuation with terminal access, file browsing, git views, localhost preview, notifications, and multi-agent workflows.
* [Dorothy](https://github.com/Charlie85270/Dorothy) ⭐ 345 | 🐛 10 | 🌐 TypeScript | 📅 2026-07-07 — Open-source desktop app to orchestrate multiple AI coding agents (Claude Code, Codex, Gemini) simultaneously with automations, Kanban management, and remote control.
* [Poirot](https://github.com/LeonardoCardoso/Poirot) ⭐ 211 | 🐛 5 | 🌐 Swift | 📅 2026-08-28 — A macOS app for browsing Claude Code sessions, exploring diffs, and re-running commands. Reads local transcripts, runs offline, open source.
* [OpenQuack](https://github.com/larryxiao/openquack) ⭐ 52 | 🐛 12 | 🌐 Swift | 📅 2026-08-31 - Privacy-first local voice dictation menu bar app for macOS. Pairs with Claude Code, Cursor, Codex, and Aider to dictate long contextual prompts; transcribes via WhisperKit on Apple Silicon, pastes at the cursor, \~8 MB, MIT.
* [Clave](https://github.com/codika-io/clave) ⭐ 47 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-08 — Native macOS app for managing multiple Claude Code sessions in parallel, with split/grid layouts, session groups, SSH remote sessions, a git panel, conversation history, and usage analytics. Free, open-source (MIT), local-first.
* [Anima](https://github.com/btangonan/anima) ⭐ 17 | 🐛 3 | 🌐 JavaScript | 📅 2026-06-16 — Native macOS companion for Claude Code with per-project ASCII familiars, nim token economy, and cross-session watcher. Tauri v2 + Rust, 4MB.
...
* [Qodo PR Agent](https://github.com/qodo-ai/pr-agent) ⭐ 12,898 | 🐛 107 | 🌐 Python | 📅 2026-09-08 — Open source tool for automated code reviews. Qodo was formerly known as Codium (not to be confused with Codeium with an "E").
* [Gito](https://github.com/Nayjest/Gito) ⭐ 432 | 🐛 58 | 🌐 Python | 📅 2026-09-05 - AI code reviewer that works with any language model, locally or in GitHub Actions.
* [Z.ai Code Review](https://github.com/tarmojussila/zai-code-review) ⭐ 43 | 🐛 2 | 🌐 JavaScript | 📅 2026-04-16 - AI-powered GitHub Pull Request code review using Z.ai models.
* [MiniMax Code Review](https://github.com/tarmojussila/minimax-code-review) ⭐ 20 | 🐛 4 | 🌐 JavaScript | 📅 2026-04-16 - AI-powered GitHub Pull Request code review using MiniMax models.
...
* [prpack-action](https://github.com/Lucas2944/prpack-action) ⭐ 1 | 🐛 0 | 📅 2026-05-12 — GitHub Action that runs prpack on every PR, uploads the packed markdown as an artifact, and posts a summary comment. MIT.
...
* [Trellis](https://github.com/mindfold-ai/Trellis) ⭐ 14,536 | 🐛 52 | 🌐 TypeScript | 📅 2026-08-27 — All-in-one AI framework & toolkit for Claude Code & Cursor. Manages tasks, specs, and multi-agent pipelines.
* [Bernstein](https://github.com/chernistry/bernstein) ⭐ 1,128 | 🐛 314 | 🌐 Python | 📅 2026-09-08 — Deterministic multi-agent orchestrator that spawns parallel coding agents (Claude Code, Codex CLI, Gemini CLI) from a single goal, verifies with tests, and auto-commits. Zero LLM tokens on coordination.
* [Sidecar](https://github.com/marcus/sidecar) ⭐ 1,054 | 🐛 28 | 🌐 Go | 📅 2026-09-07 — Terminal UI companion for CLI-based coding agents (Claude Code, Cursor, Gemini) with unified conversation history, git integration, task management, and workspace control.
* [SwarmClaw](https://github.com/swarmclawai/swarmclaw) ⭐ 667 | 🐛 18 | 🌐 TypeScript | 📅 2026-06-30 - Self-hosted AI runtime that orchestrates Claude Code, Codex, Gemini CLI, OpenCode, Copilot CLI, Cursor Agent, Goose, Qwen Code, and Droid with heartbeats, schedules, delegation, runtime skills, and an org chart view. Ships as a desktop app (Electron) and CLI. MIT licensed, TypeScript.
* [GolemBot](https://github.com/0xranx/golembot) ⭐ 321 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-05 — Unified framework wrapping Claude Code, Cursor, OpenCode, and Codex CLIs behind a single streaming API. Adds IM adapters (Slack, Telegram, Discord, Feishu), Skill system, fleet mode, and HTTP embedding.
* [OpenASE](https://github.com/pacificstudio/openase) ⭐ 266 | 🐛 45 | 🌐 Go | 📅 2026-08-09 — Open-source ticket-driven platform for orchestrating Claude Code, Codex, and Gemini CLI agents across isolated workspaces and status-based workflows.
* [Shep](https://github.com/shep-ai/cli) ⭐ 248 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-07 — Multi-session SDLC control center that orchestrates AI coding agents (Claude Code, Cursor CLI, Gemini) for autonomous feature development with configurable approval gates and a live web dashboard.
* [LoopTroop](https://github.com/looptroop-ai/LoopTroop) ⭐ 131 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-08 — Local GUI orchestrator for AI coding agents with multi-model planning (LLM councils), iterative retry loops, and isolated git worktrees for long-running, correctness-first multi-file work.
* [osModa](https://github.com/bolivian-peru/os-moda) ⭐ 117 | 🐛 11 | 🌐 Rust | 📅 2026-06-24 — NixOS-based AI operating system with multi-agent routing (Opus agent for full system access, Sonnet agent for mobile/concise). Modular runtime swaps Claude Code and OpenClaw drivers per-agent via SIGHUP — no SSH or rebuild. 91 typed MCP tools across 9 Rust daemons, hash-chained audit ledger, atomic NixOS rollback, P2P encrypted mesh (Noise\_XX + ML-KEM-768 hybrid PQ), encrypted credential store (AES-256-GCM). Spawn-on-demand via x402-payable API. Apache-2.0.
* [GreatCTO](https://github.com/avelikiy/great_cto) ⭐ 89 | 🐛 7 | 🌐 JavaScript | 📅 2026-09-08 — Multi-agent SDLC orchestrator running above Claude Code, Cursor, Codex, Aider, and Continue. 34 specialist agents (architect → reviewers → devops), 25 archetype overlays (fintech, healthcare, agent-product, voice-AI), and 10 compliance packs (PCI/HIPAA/EU AI Act/TCPA) auto-wired by repo detection. Two human gates per feature.
* [great\_cto](https://github.com/avelikiy/great_cto) ⭐ 89 | 🐛 7 | 🌐 JavaScript | 📅 2026-09-08 — Claude Code plugin with 7 specialized agents (tech-lead, senior-dev, qa-engineer, security-officer, devops, l3-support, project-auditor) running a full SDLC pipeline with 12-angle code review, 10 project archetypes, 13 compliance frameworks, and two-gate approval flow (architecture + deploy).
* [Forge](https://github.com/LucasDuys/forge) ⭐ 55 | 🐛 0 | 🌐 JavaScript | 📅 2026-07-15 — Autonomous spec-driven development loop for Claude Code. Three-command pipeline (brainstorm, plan, execute) that turns ideas into shipped code with context survival, backpropagation, and Claude-on-Claude code review.
* [pi-ralph](https://github.com/samfoy/pi-ralph) ⭐ 16 | 🐛 1 | 🌐 TypeScript | 📅 2026-05-14 — Multi-agent orchestration loops for the pi coding agent. Runs autonomous implementation, review, and debugging cycles with configurable roles and loop chaining.
* [Kagan](https://github.com/kagan-sh/kagan) ⭐ 10 | 🐛 7 | 🌐 TypeScript | 📅 2026-07-28 — Open-source AI orchestration board with a VS Code extension for planning, running, and reviewing coding agent tasks.
...
* [mirrord](https://github.com/metalbear-co/mirrord) ⭐ 5,323 | 🐛 84 | 🌐 Rust | 📅 2026-09-08 — Per-agent isolation inside a shared Kubernetes cluster: traffic filters, DB branches, and Kafka queue splits via the mirrord Operator. Six [Claude Code skills](https://github.com/metalbear-co/skills) ⭐ 27 | 🐛 1 | 🌐 Shell | 📅 2026-09-08 cover quickstart, config, operator setup, CI, DB branching, and Kafka splitting; install via `/plugin marketplace add metalbear-co/skills`.
* [Open Agent](https://github.com/Th0rgal/openagent) ⭐ 507 | 🐛 15 | 🌐 Rust | 📅 2026-09-08 — Self-hosted control plane for Claude Code with isolated container workspaces and real-time mission streaming.
* [brood-box](https://github.com/stacklok/brood-box) ⭐ 65 | 🐛 13 | 🌐 Go | 📅 2026-09-08 — Run coding agents (Claude Code, Codex, OpenCode) inside hardware-isolated microVMs with snapshot isolation and egress control.
* [AgentTier](https://github.com/agenttier/agenttier) ⭐ 61 | 🐛 19 | 🌐 Go | 📅 2026-09-07 — Open-source, Kubernetes-native sandbox runtime for AI coding agents (Claude Code, LangGraph, OpenHands). Each sandbox is a Pod + PVC + default-deny NetworkPolicy with optional gVisor isolation; runs in interactive `mode: code` (browser terminal) or `mode: agent` (REST `/configure` + SSE-streaming `/invoke`). Apache-2.0.
...
* [Caliber](https://github.com/rely-ai-org/caliber) ⭐ 1,263 | 🐛 16 | 🌐 TypeScript | 📅 2026-07-26 — Open-source CLI that scans your codebase and generates AI agent configs (CLAUDE.md, .cursorrules, skills, MCPs) for Claude Code, Cursor, and Codex. Scores your setup 0-100 and recommends MCP servers.
* [SwarmVault](https://github.com/swarmclawai/swarmvault) ⭐ 681 | 🐛 8 | 🌐 TypeScript | 📅 2026-06-30 - Local-first RAG knowledge vault and MCP server. Compiles raw sources (books, notes, transcripts, exports, datasets, slide decks, files, URLs, code) into a durable markdown wiki with a knowledge graph and a hybrid SQLite FTS plus embeddings index. The bundled MCP server (`npx -y @swarmvaultai/cli mcp`) gives Claude Code, Codex, OpenCode, and any MCP client page search, page reads, source listing, query, ingest, compile, and lint tools. MIT.
* [Entroly](https://github.com/juyterman1000/entroly) ⭐ 443 | 🐛 0 | 🌐 Python | 📅 2026-09-08 - Open-source context optimization engine that cuts AI token costs by 70-95%. Uses submodular knapsack selection and PRISM reinforcement learning to provide the exact context needed to 65+ supported AI coding agents. Features a built-in MCP server, semantic caching, and SimHash deduplication. Apache-2.0.
* [GAAI Framework](https://github.com/Fr-e-d/GAAI-framework) ⭐ 161 | 🐛 9 | 🌐 Shell | 📅 2026-09-08 — Drop-in governance layer for AI coding tools. Backlog-first delivery, cross-session memory, decision tracking, QA gates, and autonomous delivery daemon. Works with Claude Code, Cursor, Codex CLI, Gemini CLI, Windsurf. Markdown + YAML + bash, zero dependencies.
* [KubeStellar Console kc-agent](https://github.com/kubestellar/console) ⭐ 133 | 🐛 169 | 🌐 TypeScript | 📅 2026-09-08 — MCP server that bridges AI coding agents (Claude Code, Copilot, Codex) to multi-cluster Kubernetes APIs. Enables natural language queries across clusters, workload placement, policy enforcement, and real-time observability. CNCF Sandbox project.
* [Spartan AI Toolkit](https://github.com/spartan-stratos/spartan-ai-toolkit) ⭐ 98 | 🐛 2 | 🌐 JavaScript | 📅 2026-06-18 — Engineering discipline layer for AI coding agents. 67 slash commands with quality gates enforce TDD, code review, and atomic commits. Configurable rules for any stack. Works with Claude Code, Codex, Cursor, Windsurf, Copilot.
* [skill-optimizer](https://github.com/fastxyz/skill-optimizer) ⭐ 77 | 🐛 14 | 🌐 TypeScript | 📅 2026-05-28 — CLI that benchmarks SDK, CLI, and MCP guidance docs (SKILL.md) against multiple LLMs and runs an iterative optimizer to rewrite them until every configured model meets a score floor.
* [LynxPrompt](https://github.com/GeiserX/LynxPrompt) ⭐ 46 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-07 — Self-hostable platform for managing AI IDE configuration files. Generates, syncs, and shares configs (.cursorrules, CLAUDE.md, copilot-instructions.md, etc.) across 30+ AI coding assistants via web UI, REST API, CLI, and federated blueprint marketplace.
* [faf-cli](https://github.com/Wolfe-Jam/faf-cli) ⭐ 39 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-07 — Foundational AI-context format. Generates persistent project DNA (.faf files) that give any AI instant, structured context. IANA-registered (application/vnd.faf+yaml). Works with Claude, Gemini, Grok, Cursor, and Windsurf.
* [Agentify](https://github.com/koriyoshi2041/agentify) ⭐ 37 | 🐛 0 | 🌐 TypeScript | 📅 2026-03-16 — CLI tool that transforms any OpenAPI spec into 9 agent interface formats (MCP server, AGENTS.md, CLAUDE.md, .cursorrules, Skills, llms.txt, GEMINI.md, A2A Card, CLI) with a single command. Tiered generation strategies for small to large APIs.
* [claude-code-pro-pack](https://github.com/sisyphusse1-ops/claude-code-pro-pack) ⭐ 36 | 🐛 0 | 🌐 HTML | 📅 2026-05-10 — Drop-in 12-rule `CLAUDE.md` + `AGENTS.md` baseline that closes common agent-orchestration failures (token spirals, silent partial failures, two-pattern pollution). Includes PRD generator prompt, browser-skill-graduation workflow, and 5 example skills. \~700 tokens total, MIT.
* [ctxlint](https://github.com/YawLabs/ctxlint) ⭐ 10 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-23 — Open-source linter for AI context files (CLAUDE.md, .cursorrules, copilot-instructions.md) that catches stale paths, wrong commands, and token waste by validating against the real codebase.
* [pi-steering-hooks](https://github.com/samfoy/pi-steering-hooks) ⭐ 8 | 🐛 1 | 🌐 TypeScript | 📅 2026-05-14 — Deterministic before-tool-call guardrails for the pi coding agent. Enforces rules (no force push, conventional commits, etc.) via regex pattern matching on tool inputs — zero tokens, 100% reliable. Custom rules via JSON config with override escape hatch.
* [claude-overlay](https://github.com/mzmmoazam/claude-overlay) ⭐ 4 | 🐛 0 | 🌐 Shell | 📅 2026-09-04 — CLI for managing Claude Code project configs across custom providers (Databricks, Bedrock, OpenRouter, LiteLLM, Cloudflare). Handles overlay merge/remove, web search MCP setup, and multi-provider switching.
* [intelligence-sync](https://github.com/ainova-systems/intelligence-sync) ⭐ 4 | 🐛 0 | 🌐 Shell | 📅 2026-08-28 — One source of truth for AI coding rules across every IDE. Author rules, agents, and skills once in plain markdown, and the engine routes them into each tool's native format (Claude Code, Cursor, Copilot, Codex, Pi, OpenCode, AGENTS.md) with no duplication or drift. Zero dependencies, bash + awk, MIT.
* [claude-snapshot](https://github.com/adhenawer/claude-snapshot) ⭐ 2 | 🐛 1 | 🌐 JavaScript | 📅 2026-04-19 — Export your entire Claude Code setup (settings, plugins, hooks, CLAUDE.md, MCP configs) as a portable `.tar.gz`. Diff before applying, restore on another machine in under 2 minutes. No network, no daemon, `.bak` safety on every overwrite. Node.js 18+, macOS + Linux. Install: `/plugin marketplace add adhenawer/claude-snapshot`
* [TokRepo](https://github.com/henu-wang/tokrepo) ⭐ 0 | 🐛 0 | 📅 2026-05-18 — Cross-agent registry and CLI for discovering and installing 220+ AI assets including skills, prompts, MCP configs, and workflows.
* [cc-audit](https://github.com/sisyphusse1-ops/cc-audit) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-05-10 — Single-file Python linter that scores any `CLAUDE.md` / `AGENTS.md` against a 12-rule baseline. Flags leaked secrets (GitHub PATs, AWS keys, PayPal links), the 200-line compliance cliff, and missing project-specifics sections. Zero dependencies, JSON output for CI, MIT.
...
* [Tokscale](https://github.com/junhoyeo/tokscale) ⭐ 5,355 | 🐛 68 | 🌐 Rust | 📅 2026-09-08 — CLI tool for tracking token usage from AI coding agents (OpenCode, Claude Code, OpenClaw, Codex, Gemini CLI, Cursor IDE, AmpCode, Factory Droid) with a global leaderboard and 2D/3D contribution graphs.
* [onWatch](https://github.com/onllm-dev/onwatch) ⭐ 729 | 🐛 8 | 🌐 Go | 📅 2026-09-07 — Open-source Go CLI that tracks AI API quota usage across 7 providers (Anthropic, OpenAI Codex, GitHub Copilot, Synthetic, Z.ai, MiniMax, Antigravity). Background daemon with Material Design 3 web dashboard, \~15MB binary, <50MB RAM, zero telemetry.
* [claude-lens](https://github.com/Astro-Han/claude-lens) ⭐ 229 | 🐛 3 | 🌐 Shell | 📅 2026-07-28 — Lightweight Bash + jq statusline for Claude Code with rate limit pace tracking. Compares burn rate to time remaining in 5h/7d windows, showing whether usage is ahead or behind sustainable pace. Single file, zero dependencies beyond jq.
* [agenttrace](https://github.com/luoyuctl/agenttrace) ⭐ 130 | 🐛 7 | 🌐 Rust | 📅 2026-09-07 — Local-first TUI observability for AI coding agents. Tracks cost, tokens, tool failures, anomalies, health, and CI gates across Claude Code, Codex CLI, Gemini CLI, Aider, and Cursor exports.
* [Code Insights](https://github.com/melagiri/code-insights) ⭐ 76 | 🐛 11 | 🌐 TypeScript | 📅 2026-06-01 — Local-first CLI and dashboard for analyzing AI coding sessions from Claude Code, Cursor, Codex CLI, Copilot CLI, and VS Code Copilot Chat. SQLite-backed with terminal analytics, browser dashboard, and LLM-powered insights.
* [WhereMyTokens](https://github.com/jeongwookie/WhereMyTokens) ⭐ 76 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-26 — Windows system tray app for monitoring Claude Code token usage in real time. Displays per-session token counts, costs, context window usage, and tool call breakdowns; fetches 5h/1w rate-limit data from the Anthropic API with optional statusLine bridge integration for live data without polling.
* [TokenWise](https://github.com/CodeShuX/tokenwise) ⭐ 3 | 🐛 0 | 🌐 HTML | 📅 2026-08-26 — Measurement-driven model router for Claude Code. Auto-routes subtasks across Haiku/Sonnet/Opus based on task class, logs every routed task with verified $ saved to a local NDJSON, and includes an A/B test subcommand to validate cheaper tiers before trusting routing. MIT, zero telemetry, Anthropic-only.
* [cc-tempo](https://github.com/O0000-code/cc-tempo) ⭐ 1 | 🐛 0 | 🌐 Shell | 📅 2026-05-07 — Claude Code statusline that parses transcript JSONL for active work time (excludes idle and interactive-tool waits), SubAgent speedup ratio, /clear-resilient PID timer, code-churn sparkline with trend arrow, and multi-instance detection. Bash + TypeScript CLI, MIT.
...
* [git-lrc](https://github.com/HexmosTech/git-lrc) ⭐ 1,461 | 🐛 17 | 🌐 Go | 📅 2026-09-05 - Free, unlimited AI code reviews that run on every commit.
...
* [AI Coding Guide (中文)](https://github.com/jnMetaCode/ai-coding-guide) ⭐ 519 | 🐛 1 | 🌐 CSS | 📅 2026-07-23 — Chinese best practices for 8 AI coding tools (Claude Code, Cursor, Copilot, Windsurf, Gemini CLI, Kiro, Aider, Trae) with copy-paste config templates and multi-tool collaboration workflows.
* [Awesome AI Startups — Coding & Developer Tools](https://github.com/nowork-studio/awesome-ai-startups#-coding--developer-tools) ⭐ 79 | 🐛 42 | 📅 2026-09-07 — 100+ indie-built AI coding assistants, dev tools, and code-generation products from bootstrapped, pre-seed, and angel-funded startups.
* [Awesome Code Docs](https://github.com/johnxie/awesome-code-docs) ⭐ 59 | 🐛 0 | 🌐 Python | 📅 2026-09-07 — Curated deep-dive tutorials for open-source AI and developer tooling projects.
